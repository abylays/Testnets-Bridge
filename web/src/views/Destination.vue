<template>
  <div class="text-center pt-12">
    ...
    <p>
      This bridge allows you to send OutpeerDollars (OPD) from
      {{ destinationNetwork }} back to {{ originNetwork }}
    </p>
    ...
    <form class="w-96 mt-8 mx-auto">
      <label for="price" class="block mb-2 font-medium text-gray-700"
        >How much D-OPD do you want to bridge?</label
      >
...
import DOutpeerDollars from "@/artifacts/contracts/DestinationToken.sol/DOutpeerDollars.json";
import OutpeerDollars from "@/artifacts/contracts/OriginToken.sol/OutpeerDollars.json";
